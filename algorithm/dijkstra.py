...
# -> 노드의 개수가 10,000개가 넘어가면  대략 1억번의 연산 횟수가 소요됨
# -> 코테의 경우 시간 초과할 수 있음. (1초당 20,000,000의 연산 횟수랑 가정)
import sys
...
# 02. 개선된 구현
# 우선순위 큐(Priority Queue)를 활용하여 구현
...
import sys
input = sys.stdin.readline
INT = int(1e9)  # 무한을 의미하는 값으로 10억을 설정
...
def dijkstra(start):
	q = []
	# 시작 노드로 가기 위한 최단 경로는 0으로 설졍하여, 큐에 삽입
